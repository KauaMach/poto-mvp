...
| **Deploy** | **1 unit systemd na Pi** | Sem GPIO no MVP, a Pi é puramente um servidor local: um serviço, boot rápido, headless. | **Docker**: overhead de boot/RAM sem ganho nenhum para um processo só |
